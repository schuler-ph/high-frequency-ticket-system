...
| ADR-011 Capacity Model vs. Pre-generated Tickets           | Fertig           | Phase 2/3/3.5 umgesetzt: capacity-basiert, on-the-fly INSERT. Nachtrag Backlog #7 (2026-07-18): sold_count-Hot-Row-UPDATE entfernt, Verkaufsstand via COUNT(tickets) im Reconcile aggregiert |
...
| ADR-022 Periodischer Reconcile-Loop (Singleton-Deployment) | Wird abgeloest   | Historischer Stand aus Phase 3.5; Phase 4.9 entfernt den schreibenden Loop zugunsten von ADR-031                                                                                             |
...
| ADR-030 Grafana-Panel-Export als PNG                       | Fertig           | Lasttest-Report-Automation exportiert alle Graph-Panels reproduzierbar in das Run-Artefakt                                                                                                   |
| ADR-031 Redis-authoritatives Inventory                     | Geplant          | Phase 4.9: schreibenden Reconcile durch Inventory Auditor, Sold-count Projector, Capacity-Invariante und Pending-Reaper ersetzen                                                             |
...
- **Wird abgeloest:** Historischer Codepfad ist noch aktiv, seine Entfernung beziehungsweise Ersetzung ist aber bereits entschieden und geplant.
...
- **Umsetzungsplan:** `docs/TODO.md` Phase 4.9; Detailplan und Dashboard-Zuordnung in `docs/notes/phase-4-9-inventory-integrity.md`.
