...
/**
 * Die UUID des einen Festival-Sales, den dieses System abwickelt (ADR-043).
 *
 * `scripts/local/lib/stack-steps.mjs` traegt denselben Wert als Literal — wer
 * ihn aendert, aendert beide Stellen.
 */
